<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-gray-800 leading-tight">Balance Anual</h2>
                <p class="text-sm text-gray-600 mt-1">Resumen financiero año por año</p>
            </div>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
        <div class="py-8 sm:py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                @include('balances.partials.filtros', ['route' => route('balances.anual'), 'filtros' => $filtros, 'clinicas' => $clinicas])
                        ...
                        <div class="p-4 sm:p-6 md:p-8">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-3">
                                <div class="flex items-center space-x-3">
                                    <div class="bg-gradient-to-br from-orange-500 to-red-600 rounded-xl p-2.5">
                                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0 2 2 0 011.523-1.943A5.977 5.977 0 0116 10c0 .34-.028.675-.083 1H15a2 2 0 00-2 2v2.197A5.973 5.973 0 0110 16v-2a2 2 0 00-2-2 2 2 0 01-2-2 2 2 0 00-1.668-1.973z" clip-rule="evenodd"></path></svg>
                                    </div>
                                    <h3 class="text-xl font-bold text-gray-900">Balance Anual</h3>
                                </div>
                                <span class="text-xs font-medium text-gray-500 bg-gray-100 px-3 py-1 rounded-full">{{ $balances->count() }} años</span>
                            </div>
                                    ...
                                    <div class="overflow-hidden">
                                        <table class="min-w-full text-sm text-left text-gray-700">
                                            <thead class="text-xs text-gray-700 uppercase bg-gradient-to-r from-gray-100 to-gray-50">
                                                <tr>
                                                    <th class="px-4 sm:px-6 py-3 sm:py-4 font-bold whitespace-nowrap">Año</th>
                                            ...
                                            <tbody class="divide-y divide-gray-200">
                                                ...
                                                <tr class="hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td class="px-4 sm:px-6 py-4 text-center whitespace-nowrap">
                                                        <a href="{{ route('balances.detalle', ['periodo' => 'anual', 'anio' => $balance->period, 'periodo_index' => 1, 'clinica_id' => $filtros['clinica_id'], 'estado' => $filtros['estado']]) }}" class="inline-flex items-center px-3 py-1.5 bg-orange-100 text-orange-700 rounded-lg hover:bg-orange-200 transition-colors text-xs font-medium">Ver</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
